...
public class HelloWorld {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		//setting images
		//Image gameBoard, questionScreen;
		//gameBoard = Toolkit.getDefaultToolkit().getImage("H:/git/ICS3U/ICS3UP/resource/blankJepBoard.jpg");
		c.setTextBackgroundColor(Color.blue);
		c.setTextColor(Color.yellow);
		c.clear();
		//c.drawImage(gameBoard, 0, 100, 640,420, null);
		
		
		
		//setting mouse click things
